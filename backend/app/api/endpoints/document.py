...
async def upload_documents(
    ...
    for file in files:
        ...
        background_tasks.add_task(process_document_background, doc.id, file_path, doc_type)
...
def get_documents(
    ...
    if current_user.role == "Admin":
        ...
        docs = session.query(Document).filter(Document.owner_id == current_user.id).all()
    return docs
